      ...
      <div className="max-w-site mx-auto">
        ...
        <div className="mb-16">
          ...
          <h1 className="font-display text-[clamp(3rem,8vw,6rem)] leading-[0.95] tracking-wide text-offwhite mt-6 mb-4">
            PROJETOS QUE<br />
            <span className="text-yellow">GERAM</span> RESULTADO
          </h1>
          ...
          {projetos.map((projeto) => (
            ...
            >
              ...
              <div className="relative aspect-[4/3] bg-black-mid overflow-hidden">
                ...
                {projeto.destaque && (
                  <div className="absolute top-4 right-4">
                    <span className="text-[0.6rem] font-bold tracking-widest uppercase bg-yellow text-black px-2 py-0.5 rounded-sm">
                      Destaque
                    </span>
                  </div>
                )}
              ...
              <div className="p-6">
                ...
                <h2 className="font-display text-[1.4rem] tracking-wide text-offwhite mb-2 group-hover:text-yellow transition-colors">
                  {projeto.titulo}
                </h2>
                <p className="text-sm text-offwhite/50 leading-relaxed mb-4">
                ...
                <div className="flex flex-wrap gap-1.5 mb-5">
                  {projeto.servicos.slice(0, 3).map((s) => (
                    <span key={s} className="text-[0.6rem] font-bold tracking-widest uppercase bg-black text-offwhite/40 border border-offwhite/10 px-2 py-0.5 rounded-sm">
                      {s}
                    </span>
                  ))}
                </div>
        ...
        <div className="mt-20 p-10 bg-yellow rounded-lg text-center">
          <h2 className="font-display text-[2.2rem] text-black tracking-wide mb-2">
            Quer ser o próximo caso de sucesso?
          </h2>
          <p className="text-black/60 mb-6 max-w-lg mx-auto">
            Fale com a gente e descubra como podemos transformar a presença digital do seu negócio.
          </p>
          <Link
            href="/#contato"
