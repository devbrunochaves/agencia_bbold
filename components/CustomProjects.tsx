...
export default function CustomProjects() {
  return (
    <section id="pacotes" className="bg-[#f0e8d8] border-y border-black/[0.04] py-24 px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0.5 mb-16">
          {scenarios.map((s) => (
            ...
            >
              ...
              <h3 className="font-display text-[1.8rem] tracking-wide text-black mb-3">{s.title}</h3>
              <p className="text-[0.92rem] text-black/50 leading-relaxed mb-5">{s.desc}</p>
