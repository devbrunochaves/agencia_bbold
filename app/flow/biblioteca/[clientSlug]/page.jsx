    ...
    <>
      ...
      <main className="f-content">
        ...
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
          ...
          {(fType || search) && (
            <button className="f-btn-ghost" style={{ fontSize:12 }} onClick={() => { setFType(''); setSearch('') }}>
              Limpar filtros
            </button>
          )}
        </div>
